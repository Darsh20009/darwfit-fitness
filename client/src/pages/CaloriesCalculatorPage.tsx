...
<old_str>// Temporary food database
const foodDatabase = {
  "المطبخ المصري": {
...
// Convert nested object to flat array with category and name
const foodDatabase = [];
Object.keys(foodCategories).forEach(category => {
  Object.keys(foodCategories[category]).forEach(foodName => {
    foodDatabase.push({
      name: foodName,
      category: category,
      calories: foodCategories[category][foodName].calories,
      protein: foodCategories[category][foodName].protein,
      carbs: foodCategories[category][foodName].carbs
    });
  });
});</new_str>
