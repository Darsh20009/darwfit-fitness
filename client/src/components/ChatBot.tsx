...
const botResponses: Record<string, { text: string; options?: string[] }> = {
  start: {
    ...
    options: ["معلومات عن الاشتراكات", "استفسارات غذائية", "استفسارات تدريبية", "استعادة رقم الاشتراك", "الدعم الفني", "كيف أضيف عميل جديد؟"]
  },
  "معلومات عن الاشتراكات": {
    text: "نقدم باقات اشتراك متنوعة تناسب احتياجاتك وميزانيتك:",
    options: ["باقة شهر", "باقة 3 شهور", "باقة 6 شهور", "باقة سنة كاملة", "رجوع"]
  },
  "باقة شهر": {
  ...
  "باقة 3 شهور": {
    text: "باقة الثلاثة أشهر تكلفتها 100 ريال فقط. تشمل برنامج غذائي مخصص، برنامج تدريبي متكامل ومتابعة أسبوعية من المدرب. هذه الباقة هي الأكثر شعبية.",
    options: ["كيف أشترك؟", "رجوع للباقات"]
  },
  "باقة 6 شهور": {
    text: "باقة الستة أشهر تكلفتها 200 ريال فقط. تشمل جميع مزايا الباقة السابقة بالإضافة لمتابعة شهرية مع المدرب وخصم 20% على التجديد.",
    options: ["كيف أشترك؟", "رجوع للباقات"]
  },
  "باقة سنة كاملة": {
    text: "باقة السنة الكاملة تكلفتها 500 ريال فقط. تشمل جميع المزايا السابقة بالإضافة لتواصل مباشر مع المدرب الشخصي وخصم 30% على التجديد.",
    options: ["كيف أشترك؟", "رجوع للباقات"]
  },
  "كيف أضيف عميل جديد؟": {
    text: "لإضافة عميل جديد، يجب على العميل أولاً إكمال استمارة الاشتراك من صفحة 'الاشتراكات'. بعد ذلك، يمكنك كمدير النظام إضافة بيانات الدخول الخاصة به بما في ذلك اسم المستخدم وكلمة المرور ورقم الاشتراك الخاص به (مثل: 5002، 5003، إلخ). يرجى تذكر أن رقم الاشتراك 5001 محجوز للعميل 'محمد السهلي'.",
    options: ["الذهاب لصفحة الاشتراكات", "رجوع للقائمة الرئيسية"]
  },
  "الذهاب لصفحة الاشتراكات": {
    text: "تم تحويلك إلى صفحة الاشتراكات. هل تحتاج إلى مساعدة أخرى؟",
  ...
  "اقتراح أو شكوى": {
    text: "نحن نقدر اقتراحاتك وملاحظاتك. يمكنك إرسال اقتراح أو شكوى عبر البريد الإلكتروني: darwfit@outlook.com وسيتم الرد عليك خلال 24 ساعة عمل.",
    options: ["رجوع للدعم الفني"]
  },
  "التواصل المباشر": {
    text: "للتواصل المباشر مع المدرب، يمكنك التواصل عبر الواتساب على الرابط التالي: https://api.whatsapp.com/send/?phone=201155201921",
    options: ["رجوع للقائمة الرئيسية"]
  },
  "رجوع للدعم الفني": {
